...
np.savetxt('0.008_2_VN1_01.csv', np.array(z[1]))
np.savetxt('0.008_2_VN2_01.csv', np.array(z[2]))
np.savetxt('0.008_2_Time_01.csv', np.array(z[0]))
...
plt.title('2 neurons {} and {} gwn'.format(g_GJ, noise))
