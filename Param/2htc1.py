...
#till here I have initialized all the differential equations and the current equations. Now, lets work on the integrator. The thing is that the previous integrator incorporated the initial voltages of the two neurons and then performed an Euler-Mauryama integration on the entire set of differential equations. 
